...
\relatore[Dott.]{Ivan Scagnetto}
%\correlatore{Talaltro dei Tali}
%\correlatoreDue{Secondo Correlatore}
\dedica{Ai miei genitori\\ per non avermi tagliato i viveri, \\ a tutti i miei amici\\ per il continuo e incessante supporto} % (facoltativo)
