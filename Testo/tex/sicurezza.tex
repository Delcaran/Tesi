...
Per quanto riguarda lo specifico di Bitcoin, la principale minaccia all'intera rete è un utente malintenzionato con una potenza di calcolo di gran lunga superiore a quella del resto della rete.
...
%TODO lanciare programma e fare grafici
% il file risultati_nakamoto_X.dat vuol dire q=0.X . Per ogni file z=1..50
...
\begin{tikzpicture}
	...
	\begin{axis}[
		...
		\foreach \id in {1,3,6,9}
			\addplot[line width=0.5pt]
				file {risultati_nakamoto_\id.dat}
	\end{axis}
\end{tikzpicture}

\subsection{Ridurre i rischi}
...
Inoltre è da fare presente come un attacco simile sia già implementabile tramite la creazione di un numero arbitrario di transazioni
